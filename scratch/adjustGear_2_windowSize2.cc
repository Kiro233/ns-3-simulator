...
/*
NS_LOG="UdpServer=info|prefix_time|prefix_node|prefix_func" ./ns3 run scratch/adjustGear_2_windowSize2 > scratch/log.adjustGear_2.server.out --command-template="%s --gNbNum=21 --ueNumPergNb=7 --adjustInteval=0.001 --adjustDelay=0.05" 2>&1
*/
// 9-9
